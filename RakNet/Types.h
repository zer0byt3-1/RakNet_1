...
#if defined(__x86_64__) || defined(__amd64__) || defined(_M_X64) || defined(_M_AMD64) || defined(_AMD64_)

#if defined(ASSEMBLY_INTEL_SYNTAX) && defined(ASSEMBLY_BLOCK)

#undef ASSEMBLY_INTEL_SYNTAX
#undef ASSEMBLY_BLOCK
